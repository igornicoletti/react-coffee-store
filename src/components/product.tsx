...
const { productactions, productadd, productamount, productbackdrop, productcard, productcontrols, producticon, productimage, productinfo, productinput, productname, productprice, productsale } = ProductVariants()
